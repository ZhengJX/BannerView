...
public class BottomActivity extends Activity implements OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rectangleView = (RectangleView) findViewById(R.id.rl);
        rectangleView.setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                Toast.makeText(BottomActivity.this,"出现",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnNight:
                ...
                Toast.makeText(BottomActivity.this, "你点击了夜间模式", Toast.LENGTH_SHORT)
                        .show();
                break;
            case R.id.btnWord:
                changePopupWindowState();
                Toast.makeText(BottomActivity.this, "你点击了文本模式", Toast.LENGTH_SHORT)
                        .show();
                break;
            case R.id.btnExit:
                exitTheDemo();
    ...
    private void exitTheDemo() {
        changePopupWindowState();
        new AlertDialog.Builder(BottomActivity.this).setMessage("确定退出这个 Demo 吗？")
